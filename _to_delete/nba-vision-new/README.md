...
| `/teams`, `/teams/:abbr` | Index with league table, then four tabs: **Roster** (cards + full table), **Team stats** (percentiles, ranks, matchup defence by position, head-to-head against any rival), **Cap sheet** (payroll against the tax line, best and worst contracts), **History** (championship banners, franchise facts, recent Finals) |
