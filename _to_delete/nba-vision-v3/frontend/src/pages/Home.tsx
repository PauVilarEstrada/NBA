...
const FEATURES = [
  ...
  { to: '/season', title: 'Season hub', copy: 'Both conference tables, the play-in picture, fourteen leaderboards and every award race, scored.', tint: '#E5484D' },
  { to: '/rookies', title: 'Rookie class', copy: 'The whole draft board, where each pick came from, and a scored Rookie of the Year race.', tint: '#8B7BE8' },
  ...
  { to: '/league', title: 'Full season sim', copy: 'All 1,230 games, the bracket and a champion — with a franchise you invented in the league.', tint: '#BC8000' },
]
    ...
    <PageTransition>
      ...
      <section className="mt-8">
        <SectionTitle title="What's inside"
          sub={`Eleven tools, one data layer — every number on the site describes the ${engine.SEASON_LABEL} season.`} />
        <motion.div variants={stagger} initial="hidden" animate="show"
